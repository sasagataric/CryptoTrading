...
namespace CryptoTrading.Domain.Common
{
    public static class Messages
    {
        ...
        public const string COIN_ID_NULL = "Error occured while getting coin by Id, please try again.";
        public const string COIN_DELETE_ERROR = "Error occured while deleting coin, please try again.";
        public const string COIN_NOT_IN_USER_WATCHLIST= "Coin wasn't in users watchlist.";
